...
export default function PlantModal({ open, planta, onClose }) {
  ...
  // Si la planta no tiene stock definido en los datos,
  // la tratamos como "stock ilimitado"
  ...
  return (
    ...
    >
      <div
        className="max-w-2xl w-full rounded-2xl bg-white shadow-xl ring-1 ring-slate-200 overflow-hidden"
            ...
            <div className="mt-6 space-y-3">
              ...
              {!added ? (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/carrito" className="chip">
                    Ir al carrito
                  </Link>
                </div>
              )}
